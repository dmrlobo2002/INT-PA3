...
public class Client {
  ...
  private static void printMenuOptions() {
    ...
    System.out.println(
      "worst <number> - display the worst games from 1 to <number>"
    );
    System.out.println(
      "platform <platform> - enable filter so results are for specific platform"
    );
    System.out.println(
      "platform null - reset filter to expand results to all platforms"
    );
    System.out.println(
      "platforms - view the available platforms you can search for"
    );
    System.out.println("search <game_title>");
  ...
  public static void main(String[] args) {
    ...
    try (
      ...
      System.out.println(
        "Connected to " + SERVER_ADDRESS + " on port " + SERVER_PORT
      );
      ...
      while (true) {
        ...
        while ((line = in.readLine()) != null) {
          if (line.equals("<endoftransmission>")) break;
