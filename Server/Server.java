...
public Server() {
    ...
    System.out.println("SERVER: Finished reading in: " + map.size() + " games");
...
private void populatePlatforms() {
    ...
    private Map<String, String[]> getFilteredMapByPlatform(String platformFilter) {
    ...
    switch (command) {
        ...
        case "platform":
            ...
            if (tokens[1].equals("null")) // if the second token is "null", clear the platform filter
                platformFilter = null;
            else if(!platforms.contains(tokens[1])) // if the platform is not in the list of available platforms, return an error message
                return "Invalid platform. Please type 'platform' to see a list of available platforms \n<endoftransmission>";
            else // set the platform filter to the second token
                platformFilter = tokens[1];
            return "Platform filter set to: " + platformFilter + "\n<endoftransmission>"; // return a message confirming the platform filter has been set
        case "platforms":
   ...
   private String getAllPlatforms() {
    ...
    sb.append("Here is a list of platforms for which you can enable a filter for:\n");
    ...
    private String getRandomGame() {
        ...
        String[][] games = getFilteredMapByPlatform(platformFilter).values().toArray(new String[0][0]);
   ...
   private String getRandomGames(int num) {
    ...
    private String getWorstGames(int numGames) {
        ...
        for (String[] game : games) {
            if (!game[4].equalsIgnoreCase("tbd") && !game[5].equalsIgnoreCase("tbd")) {
